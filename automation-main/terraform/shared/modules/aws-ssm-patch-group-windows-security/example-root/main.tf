/*
  Description: Terraform main file; This shows how to integrate the aws-ssm-patch-group-windows module into a root module
  Comments:
...
//   windows_versions           = []                                    # (optional) (list) Windows versions covered by the patch group
...
module "ssm_patch_group_required_inputs_example" {
  source                     = "../../aws-ssm-patch-group-windows-security"
