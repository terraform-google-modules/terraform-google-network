Legacy-Null-Context
======================
This is a legacy version of the null-context module. This should only exist until there is a Terraform Registry where versioning of the null-context module can live.
