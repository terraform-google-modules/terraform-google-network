...
//   source                     = "../../aws-ssm-patch-group-ubuntu-all" # This should point back to the original module.
...
//   ubuntu_versions            = []                                     # (optional) (list) Ubuntu versions covered by the patch group
...
module "ssm_patch_group_required_inputs_example" {
  source                     = "../../aws-ssm-patch-group-ubuntu-security"
