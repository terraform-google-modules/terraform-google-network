...
//   source = "../../../modules/terraform-aws-endpoint-multiport-multitarget"
...
//   nlb_target_id                = (required) (List) NLB will redirect to this instance
...
module "endpoint_test_instance" {
  ...
  nlb_name        = "${local.layer00.base_context.customer}-test"
  nlb_port_list   = ["80", "443"]
  nlb_target_id = [
    local.layer00.test_instance1,
    local.layer00.test_instance2,
  ]
