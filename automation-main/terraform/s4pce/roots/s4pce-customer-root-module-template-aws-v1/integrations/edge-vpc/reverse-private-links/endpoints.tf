...
module "endpoint_list" {
  ...
  endpoint_subnet_list = [
    local.layer_00_outputs.infrastructure.subnet_edge_1a.id,
    local.layer_00_outputs.infrastructure.subnet_edge_1b.id,
    local.layer_00_outputs.infrastructure.subnet_edge_1c.id,
  ]
}
