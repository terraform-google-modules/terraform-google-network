...
module "ha_endpoints" {
  ...
  nlb_subnet_list = [
    local.layer_00_outputs.infrastructure["subnet_production_1a"].id,
    local.layer_00_outputs.infrastructure["subnet_production_1b"].id,
    local.layer_00_outputs.infrastructure["subnet_production_1c"].id,
  ]
