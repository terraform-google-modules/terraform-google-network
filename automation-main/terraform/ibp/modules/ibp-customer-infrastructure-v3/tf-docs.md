...
| <a name="input_network"></a> [network](#input\_network) | New Network Variable format. | <pre>object({<br/>    use_new_network_model = bool<br/>    primary = object({<br/>      cidr = string<br/>      subnets = map(object({<br/>        zone = string<br/>        cidr = string<br/>      }))<br/>      subnets_edge = map(object({<br/>        zone = string<br/>        cidr = string<br/>      }))<br/>    })<br/>  })</pre> | n/a | yes |
...
| <a name="output_nat_gateway_route_table_id"></a> [nat\_gateway\_route\_table\_id](#output\_nat\_gateway\_route\_table\_id) | #### End Customer Nat Gateway Route Table, Routes, and Associations |
