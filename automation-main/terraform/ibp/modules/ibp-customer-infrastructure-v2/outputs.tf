...
output "subnet_edge_1c_id" { value = aws_subnet.customer_edge_1c.id }
...
output "route_table_nat_gateway_name" { value = aws_route_table.customer_nat_gateway_route.tags.Name }
output "route_table" { value = {
  ...
  nat_gateway_a = {
    name = aws_route_table.customer_nat_gateway_route.tags.Name
    id   = aws_route_table.customer_nat_gateway_route.id
  }
  nat_gateway_b = {
    name = aws_route_table.customer_nat_gateway_route_b.tags.Name
    id   = aws_route_table.customer_nat_gateway_route_b.id
  }
} }
...
output "nat_gateway" { value = {
  ngw1 = {
    name = aws_nat_gateway.customer_ngw1.tags.Name
    id   = aws_nat_gateway.customer_ngw1.id
    eip  = aws_eip.vpc_ngw1_eip.public_ip
  }
  ngw2 = {
    name = aws_nat_gateway.customer_ngw2.tags.Name
    id   = aws_nat_gateway.customer_ngw2.id
    eip  = aws_eip.vpc_ngw2_eip.public_ip
  }
} }
