...
| delete\_default\_routes\_on\_create | If set, ensure that all default routes default routes (0.0.0.0/0) are deleted immediately after network creation | string | `"false"` | no |
