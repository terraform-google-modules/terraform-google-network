...
| hub\_configuration | Configuration for the Network Connectivity Center hub. Set 'create' to true to create a new hub. If 'create' is false, you must provide the 'uri' of an existing hub. | <pre>object({<br>    create       = optional(bool, true)<br>    existing_uri = optional(string)<br>  })</pre> | n/a | yes |
