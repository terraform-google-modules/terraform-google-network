...
module "peering2" {
  source        = "terraform-google-modules/network/google//modules/network-peering"
  local_network = var.local_network # Replace with self link to VPC network "other" in quotes
  peer_network  = var.peer_network  # Replace with self link to VPC network "foobar" in quotes
}
