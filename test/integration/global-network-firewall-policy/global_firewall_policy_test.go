...
func TestGlobalNetworkFirewallPolicy(t *testing.T) {
	...
	fwp.DefineVerify(
		func(assert *assert.Assertions) {
			...
			policy := gcloud.Run(t, fmt.Sprintf("compute network-firewall-policies describe %s --global --project %s", policyName, projectID))
			...
			rule1 := gcloud.Run(t, fmt.Sprintf("compute network-firewall-policies rules describe 1 --global-firewall-policy --firewall-policy %s --project %s", policyName, projectID))
			...
			rule2 := gcloud.Run(t, fmt.Sprintf("compute network-firewall-policies rules describe 2 --global-firewall-policy --firewall-policy %s --project %s", policyName, projectID))
			...
			rule3 := gcloud.Run(t, fmt.Sprintf("compute network-firewall-policies rules describe 3 --global-firewall-policy --firewall-policy %s --project %s", policyName, projectID))
			...
			rule101 := gcloud.Run(t, fmt.Sprintf("compute network-firewall-policies rules describe 101 --global-firewall-policy --firewall-policy %s --project %s", policyName, projectID))
			...
			rule102 := gcloud.Run(t, fmt.Sprintf("compute network-firewall-policies rules describe 102 --global-firewall-policy --firewall-policy %s --project %s", policyName, projectID))
			...
			rule103 := gcloud.Run(t, fmt.Sprintf("compute network-firewall-policies rules describe 103 --global-firewall-policy --firewall-policy %s --project %s", policyName, projectID))
